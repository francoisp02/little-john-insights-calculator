      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="flex items-center justify-center mb-6">
            <img src={littleJohnLogo} alt="Little John" className="h-16 w-auto" />
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-8 animate-slide-up">
            <div className="card-premium" style={{ paddingLeft: '1cm', paddingRight: '1cm' }}>
              ...
              <div className="space-y-8">
                <SliderInput label="Nombre de contrats signés par mois" value={contractsPerMonth} onChange={setContractsPerMonth} min={limits.contracts.min} max={limits.contracts.max} step={limits.contracts.step} unit="" />
          ...
          animationDelay: '0.2s'
            ...
            {/* Dynamic Summary */}
            <div className="card-premium bg-primary-soft border-primary/20 py-[28px]">
        ...
        animationDelay: '0.4s'
          ...
          <button onClick={() => window.location.href = '/questionnaire-step-1'} className="btn-primary">
            Analyse détaillée
          </button>
        </div>

        {/* Detail Modal */}
        <DetailModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} currentData={{
        contractsPerMonth,
        averagePremium,
