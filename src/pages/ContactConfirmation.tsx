  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const completeData = {
        ...
        nombreContratsFlotteAutoSignesParMois: step2Data.contractsPerMonth,
        pourcentageProspectsDevenantClients: step2Data.conversionRate,
        primeMoyenneTTCContratFlotteAuto: step2Data.averagePremium,
        effectifTotalEntreprise: parseInt(step2Data.employeeCount) || 0,
